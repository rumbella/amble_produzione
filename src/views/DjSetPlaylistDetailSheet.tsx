...
import { Song, DjSetPlaylistDetailSheetProps } from '../types';
import SongRowItem from '../components/SongRowItem';
import { usePlayer } from '../contexts/PlayerContext';

export function DjSetPlaylistDetailSheet({ 
  isOpen, 
  onClose, 
  songsList, 
  playlist, 
...
export default DjSetPlaylistDetailSheet;
